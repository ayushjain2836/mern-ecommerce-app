  ...
  export const getSingleProductController=async (req,res)=>{
    try {
      ...
      res.status(500).send({
        success: false,
        error,
        message: "Error in  single getting product",
      });
    }
...
if(product.photo.data){
    ...
    try{ 
      ...
      res.status(200).send({
       ...
       res.status(500).send({
           success:false,
           error,
           message:'error while getting delete product'
       })
   }
  }
  ...
  export const searchProductController= async(req,res)=>{
    try{
      ...
      const result= await productModel.find({
        $or:[
          {name:{$reqex :keyword,$option:"i"}}
          ,
          {description:{$reqex :keyword,$option:"i"}}
        ]
      }).select("-photo")
      res.json("-photo")
    }catch(error)
    {
      ...
      res.status(400).send({
        success: false,
        error,
        message: "Error in search product apit",
      });
  ...
  export const relatedProductController= async(req,res)=>{
    ...
    }catch(error)
    {
      ...
      res.status(400).send({
        success: false,
        error,
        message: "Error in similar product apit",
      });
  ...
  export const productCategoryController= async(req,res)=>{
    ...
    }catch(error)
    {
      ...
      res.status(400).send({
        success: false,
        error,
        message: "Error in getting product apit",
      });
  ...
  export const braintreePaymentController=(req,res)=>{
    try{
      ...
      let newTransaction= gateway.transaction.sale({amount: total,
